    ...
    <section className="relative flex h-full min-h-0 flex-col items-center overflow-hidden px-4 pb-0 pt-3 sm:px-6 sm:pt-5 lg:px-8">
      <div className="relative z-20 flex w-full max-w-6xl shrink-0 flex-col items-center text-center">
        <div className="mt-1 inline-flex items-center gap-2 rounded-full border border-[#315376]/70 bg-[#07172a]/70 px-3 py-1.5 text-xs font-semibold tracking-[-0.01em] text-[#d7ebff] shadow-[0_12px_34px_rgb(3_8_18/0.36)] backdrop-blur-xl sm:mt-2">
          ...
          <span>For Traders. For Professionals. For You.</span>
        </div>

        <h1 className="mt-4 max-w-5xl bg-gradient-to-b from-white via-[#edf7ff] to-[#9eb7cf] bg-clip-text text-[clamp(2.8rem,6.2vw,5.75rem)] font-semibold leading-[0.9] tracking-[-0.07em] text-transparent drop-shadow-[0_18px_48px_rgb(0_0_0/0.38)] [font-family:var(--font-marketing-heading)] [text-wrap:balance]">
          Fake money
          <br />
          Real competition
        </h1>
        ...
        <Button
          asChild
          size="lg"
          className="mt-6 h-11 rounded-full border border-[#7bd7ff]/40 bg-[#ecf8ff] px-7 text-[0.95rem] font-semibold text-[#03101f] shadow-[0_16px_34px_rgb(17_191_255/0.28)] hover:bg-white sm:mt-7"
        >
          <Link href="/sign-up">
            Get started
      ...
      <div className="relative z-10 mt-10 flex min-h-0 w-full max-w-6xl translate-y-20 flex-1 items-end sm:mt-12 lg:mt-16 lg:translate-y-24">
        <div
